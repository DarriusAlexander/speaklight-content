...
$rocket_cookie_hash = 'a61e04dd108f2a5cee0370306112beb0';
$rocket_cache_reject_uri = '/(.+/)?feed/?|/checkout/(.*)|/cart/|/my-account/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$)';
...
$rocket_secret_cache_key = '5baea296e4f8e830014862';
$rocket_cache_ssl = '1';

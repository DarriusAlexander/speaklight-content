...
defined('_JEXEC') or die('Restricted access');
	...
	class UniteSettingsOutputUCWork{
		...
		*/
		 ...
		 * special inputs
		 */
		private function ____SPECIAL_INPUTS_____(){}
		...
		protected function drawInputs($setting){
			...
			$setting = UniteProviderFunctionsUC::applyFilters(UniteCreatorFilters::FILTER_MODIFY_SETTING_BEFORE_DRAW, $setting);
		...
		* set form id
		...
		private function _______DRAW_GENENRAL______(){}

...
class UniteCreatorManager{
						...
						<div class="items_wrapper unselectable">
						 	...
						 	<div id="items_outer" class="items_outer">
								...
								<div id="items_list_wrapper" class="items_list_wrapper unselectable">
									...
									<ul id="uc_list_items" class="list_items unselectable uc-listitems-<?php echo $this->type?><?php echo $addClass?>"><?php $this->putInitItems()?></ul>
	...
	* put scripts according manager type
	...
	public function outputHtml(){
		...
		<div id="uc_managerw" class="uc-manager-outer <?php echo $managerClass?>" data-type="<?php echo $this->type?>" <?php echo $this->managerAddHtml?>>

...
class UniteCreatorManagerInline extends UniteCreatorManager{
	...
	protected function putItemsButtons(){
		...
		switch($itemType){
			...
			?>
 			<a data-action="add_item" type="button" class="unite-button-primary button-disabled uc-button-item uc-button-add"><?php _e("Add Item",ADDONLIBRARY_TEXTDOMAIN)?></a>
			<?php 
			break;
			case UniteCreatorAddon::ITEMS_TYPE_IMAGE:
			?>
 			<a data-action="add_images" type="button" class="unite-button-primary button-disabled uc-button-item uc-button-add"><?php _e("Add Images",ADDONLIBRARY_TEXTDOMAIN)?></a>
			<?php 
			break;
		}

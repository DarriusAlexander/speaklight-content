...
defined('_JEXEC') or die('Restricted access');
	...
	class UniteCreatorAddonWork extends UniteElementsBaseUC{
		...
		private $arrFonts, $arrAdminLabels, $arrGridItemSettings;
		...
		/**
		 * get grid item settings array
		 */
		public function getArrGridItemSettings(){
			return($this->arrGridItemSettings);
		}
		...
		public function getAdminLabels(){
			...
			if($this->isHasItems()){
				$this->arrAdminLabels[] = array("uc_num_items", __("Items", ADDONLIBRARY_TEXTDOMAIN));
			}
		...
		/**
		 * set grid item settings (animations , bg)
		 */
		public function setGridItemSettings($arrSettings){
			$this->arrGridItemSettings = $arrSettings;
		}

 ...
 */
	class HelperUC extends UniteHelperBaseUC{
		 ...
		 */
		public static function getViewUrl($viewName, $urlParams="", $isBlankWindow = false){
		 ...
		 * get addons view url
		 */
		public static function getViewUrl_LayoutsList(){
		
			return(self::getViewUrl(GlobalsUC::VIEW_LAYOUTS_LIST));
		}
		...
		public static function getViewUrl_Layout($layoutID = null, $optParams = ""){
			...
			return(self::getViewUrl(GlobalsUC::VIEW_LAYOUT, $params));
		}
		...
		public static function getViewUrl_LayoutPreview($layoutID, $isBlankWindow = false){
			...
			//if($isBlankWindow == true)
			$url = self::getViewUrl(GlobalsUC::VIEW_LAYOUT_PREVIEW, $params, $isBlankWindow);
		 ...
		 * output layout
		 */
		public static function outputLayout($layoutID, $getHtml = false){

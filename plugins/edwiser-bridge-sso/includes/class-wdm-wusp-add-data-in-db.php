    ...
    class SsoAddDataInDB
    {
        ...
        public function deactivateLicense()
        {
            ...
            if ($licenseKey) {
                ...
                error_log('/-------------------------');
                error_log('/DEACTIVATING LICENSE SSO');
                error_log('/-------------------------');
                error_log('Bridge SSO - LICENSE DEACTIVATION REQUEST PARAMETERS :: '. json_encode($apiParams));
                error_log('Bridge SSO - LICENSE DEACTIVATION REQUEST STORE URL :: '.$this->storeUrl);
                ...
                error_log('Bridge SSO - LICENSE DEACTIVATION RESPONSE  :: '.json_encode($licenseData));
        ...
        public static function updateStatus($licenseData, $pluginSlug)
        {
            ...
            error_log('Bridge SSO - UPATED LICENSE STATUS  :: "'.$status .'"');
...
//                            }
        ...
        public function activateLicense()
        {
            ...
            if ($licenseKey) {
                ...
                error_log('/----------------------------------');
                error_log('/  LICENSING DATA SSO ');
                error_log('/---------------------------------');

                error_log('Bridge SSO - LICENSE ACTIVATION REQUEST PARAMETERS :: '.json_encode($apiParams));
                error_log('Bridge SSO - LICENSE ACTIVATION REQUEST STORE URL :: '.$this->storeUrl);
                ...
                error_log('Bridge SSO - LICENSE ACTIVATION RESPONSE  :: '.json_encode($licenseData));
        ...
        public function setTransientOnActivation($licenseStatus)
        {
            ...
            if (isset($transVar)) {
                ...
                if (!empty($licenseStatus)) {
                    ...
                    error_log('Bridge SSO - LICENSE ACTIVATION ADDING TRANSIENT FOR STATUS - "'.$licenseStatus.'" WITH TIME -"'. $time.'"');

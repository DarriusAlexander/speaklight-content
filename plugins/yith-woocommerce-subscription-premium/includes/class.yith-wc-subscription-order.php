	...
	class YWSBS_Subscription_Order {
        ...
        public function __construct() {
            ...
            if(  get_option('ywsbs_delete_subscription_order_cancelled') == 'yes'){
                add_action( 'woocommerce_order_status_cancelled', array( $this, 'delete_subscriptions' ), 10, 2 );
                add_action( 'before_delete_post', array( $this, 'delete_subscriptions' ), 10, 2 );
            }
         ...
         * @param $order_id
         */
        public function delete_subscriptions( $order_id, $post_id ) {

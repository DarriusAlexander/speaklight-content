		...
		public function init_form_fields() {
			$this->form_fields = array(
				'subject' => array(
					...
					'type' 			=> 'text',
					'description' 	=> sprintf( __( 'This controls the email subject line. Leave it blank to use the default subject: <code>%s</code>.', 'woocommerce' ), $this->subject ),
					'placeholder' 	=> '',
					'default' 		=> ''
				),
				'heading' => array(
					...
					'type' 			=> 'text',
					'description' 	=> sprintf( __( 'This controls the main heading in the notification email. Leave it blank to use the default heading: <code>%s</code>.', 'woocommerce' ), $this->heading ),
					'placeholder' 	=> '',
					'default' 		=> ''
				),
				'email_type' => array(
					...
					'type' 			=> 'select',
					'description' 	=> __( 'Choose a format for the email to send.', 'woocommerce' ),
					'default' 		=> 'html',

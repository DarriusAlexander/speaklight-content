...
if ( ! class_exists( 'YITH_WCDP_YITH_Composite_Products' ) ) {
	...
	class YITH_WCDP_YITH_Composite_Products {
		...
		public function update_cart_item( $cart_item ) {
			...
			if( YITH_WCDP_Premium()->is_deposit_enabled_on_product( $product, $variation_id ) && ! yit_get_prop( $product, 'yith_wcdp_deposit', true ) && ! apply_filters( 'yith_wcdp_skip_cart_item_processing', false, $cart_item ) ){
		...
		public function update_cart_item_data( $cart_item_data, $product_id, $variation_id ) {
			...
			if( YITH_WCDP_Premium()->is_deposit_enabled_on_product( $product_id, $variation_id ) && ! apply_filters( 'yith_wcdp_skip_cart_item_processing', false, $cart_item_data ) ){
				$deposit_forced = YITH_WCDP_Premium()->is_deposit_mandatory( $product_id, $variation_id );

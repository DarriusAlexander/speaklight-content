	...
	class YITH_WCDP_Category_Deposits_Table extends WP_List_Table {
		...
		public function prepare_items() {
			...
			if( ! empty( $registered_deposits ) ){
				...
				$column_order = isset( $_REQUEST['orderby'] ) && in_array( $_REQUEST['orderby'], array( 'product_names', 'product_prices', 'product_values', 'product_types' ) ) ? $_REQUEST['orderby'] : 'category_names';

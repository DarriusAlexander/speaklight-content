...
?>
 ...
 <fieldset class="inline-edit-col-center" xmlns="http://www.w3.org/1999/html">
	 ...
	 <label for="_create_balance_orders" class="alignleft">
		 <span class="title"><?php _e( 'How to pay Balances?', 'yith-woocommerce-deposits-and-down-payments' ) ?></span>
		 <span class="input-text-wrap">
			 <select name="_create_balance_orders" id="create_balance_orders" class="create_balance_orders">
				 ...
				 <option value="no" <?php selected( $create_balance_orders, 'no' ) ?> ><?php _e( 'Customers will pay the balance using other means (on hold)', 'yith-woocommerce-deposits-and-down-payments' ) ?></option>
			 </select>
		 </span>
	 </label>
	 <br class="clear">

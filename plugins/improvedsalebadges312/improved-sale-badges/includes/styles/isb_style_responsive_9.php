<div class="isb_sale_badge isb_group_responsive <?php echo $isb_class; ?>" data-id="<?php echo $isb_price['id']; ?>">
	<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="200" height="200" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" viewBox="0 0 200 200" xmlns:xlink="http://www.w3.org/1999/xlink">
		<g>
			<circle class="<?php echo $isb_curr_set['color']; ?>" cx="100" cy="100" r="83"/>
			<path class="<?php echo $isb_curr_set['color']; ?>" fill-opacity=".6" d="M156 14c23,29 39,163 -15,171 -53,8 -157,-85 -139,-115 18,-30 130,-84 154,-56z"/>
			<path class="<?php echo $isb_curr_set['color']; ?>" fill-opacity=".6" d="M54 7c61,-2 123,5 138,46 14,42 -105,189 -141,135 -32,-48 -57,-178 3,-181z"/>
			<path class="<?php echo $isb_curr_set['color']; ?>" fill-opacity=".6" d="M26 177c-26,-29 -7,-161 48,-175 55,-15 145,80 122,134 -23,54 -145,69 -170,41z"/>
		</g>
		<g>

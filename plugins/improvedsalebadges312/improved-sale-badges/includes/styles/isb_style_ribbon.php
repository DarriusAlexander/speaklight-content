<div class="isb_sale_badge <?php echo $isb_class; ?>" data-id="<?php echo $isb_price['id']; ?>">
	<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="0" height="60" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" viewBox="0 0 60 60" xmlns:xlink="http://www.w3.org/1999/xlink">
		...
		?>
			...
			<text text-anchor="middle" transform="scale(0.99)" x="31" y="31"  class="isb_sale_diff_shadow"><?php echo strip_tags( wc_price( $isb_price['difference'] ) ); ?> <?php esc_html_e('OFF', 'isbwoo'); ?></text>
			</g>
			<g transform="rotate(45, 33, 33)">
			<text text-anchor="middle" transform="scale(0.99)" x="30" y="30"  class="isb_sale_diff"><?php echo strip_tags( wc_price( $isb_price['difference'] ) ); ?> <?php esc_html_e('OFF', 'isbwoo'); ?></text>
			</g>
		...
		?>
			...
			<text text-anchor="middle" transform="scale(0.99)" x="0" y="39"  class="isb_sale_diff_shadow"><?php echo strip_tags( wc_price( $isb_price['difference'] ) ); ?> <?php esc_html_e('OFF', 'isbwoo'); ?></text>
			</g>
			<g transform="rotate(-45, 0, 0)">
			<text text-anchor="middle" transform="scale(0.99)" x="0" y="38"  class="isb_sale_diff"><?php echo strip_tags( wc_price( $isb_price['difference'] ) ); ?> <?php esc_html_e('OFF', 'isbwoo'); ?></text>
			</g>
			<g transform="rotate(-45, 0, 0)">

<div class="isb_sale_badge <?php echo $isb_class; ?>" data-id="<?php echo $isb_price['id']; ?>">
	<div class="isb_sale_title <?php echo $isb_curr_set['color']; ?>">
		<span class="isb_sale_title_text"><?php echo ( isset( $isb_curr_set['special_text'] ) && $isb_curr_set['special_text'] !== '' ? $isb_curr_set['special_text'] : esc_html__( 'On Sale!', 'isbwoo' ) ); ?></span>
	</div>
	...
	<div class="isb_sale_text"><?php esc_html_e('OFF', 'isbwoo'); ?></div>
		...
		<span class="isb_saved_text">
			<?php
				if ( $isb_price['type'] == 'simple' || is_singular( 'product' ) && !isset( $isb_price['type_extend'] ) ) {
					esc_html_e('Save', 'isbwoo');
				}
				else {
					esc_html_e('Up to', 'isbwoo');
				}
			?> 
		</span>

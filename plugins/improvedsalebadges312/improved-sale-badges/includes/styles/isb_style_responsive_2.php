<div class="isb_sale_badge isb_group_responsive <?php echo $isb_class; ?>" data-id="<?php echo $isb_price['id']; ?>">
	<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="200" height="200" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" viewBox="0 0 200 200" xmlns:xlink="http://www.w3.org/1999/xlink">
		<g>
			<polygon class="<?php echo $isb_curr_set['color']; ?>" points="100,0 121,20 150,13 158,42 187,50 180,79 200,100 180,121 187,150 158,158 150,187 121,180 100,200 79,180 50,187 42,158 13,150 20,121 0,100 20,79 13,50 42,42 50,13 79,20 "/>

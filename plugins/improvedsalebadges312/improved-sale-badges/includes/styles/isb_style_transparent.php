<div class="isb_sale_badge <?php echo $isb_class; ?>" data-id="<?php echo $isb_price['id']; ?>">
	<div class="isb_sale_title <?php echo $isb_curr_set['color']; ?>">
		<span class="isb_sale_title_text"><?php echo ( isset( $isb_curr_set['special_text'] ) && $isb_curr_set['special_text'] !== '' ? $isb_curr_set['special_text'] : esc_html__( 'Sale!', 'isbwoo' ) ); ?></span>
	</div>

...
var wpAjaxUrl = 'http://speaklight.org/wp-admin/admin-ajax.php';var flBuilderUrl = 'http://speaklight.org/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'http://speaklight.org/wp-content/plugins/bb-plugin/',
		wpAjaxUrl : 'http://speaklight.org/wp-admin/admin-ajax.php'
	},
	breakpoints : {
		small  : 768,
		medium : 992	},
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5b52357708533 .fl-photo-img' )
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5b52357708d3a .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5b523577084f7 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5b52357708a6b .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5b52357708aa7 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	...
	$(function() {
		$( '.fl-node-5b52357708ae3 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){

...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20200103_speaklight_24663ee6693d53a56633_20200103060934_archive.zip';
	const ARCHIVE_SIZE		 = '555813809';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '24663ee-03060934';
	const VERSION			 = '3.8.4';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v3.8.4==');
		self::log('----------------------------------------------------');
